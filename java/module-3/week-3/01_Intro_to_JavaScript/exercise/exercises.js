...
*/
		function lastDigit(x, y) {
			let isLastDigitSame = false;
			const lastXDigit = x % 10;
			const lastYDigit = y % 10;
...
*/
			function seeColor(x) {
				const xBlue = x.substring(0, 4);
				const xRed = x.substring(0, 3);
				let colorValue = "";
...
*/
				function frontAgain(string) {
					const first2 = string.substring(0, 2);
					const last2 = string.substring(string.length -2);

					let isFrontAgain = false;
